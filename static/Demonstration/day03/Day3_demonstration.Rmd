---
title: "Demonstration Day 3: Dimensional reduction visualization and clustering"
output:
...
I am currently working on multiciliated differentiation process. 
...
assuming counts follow a Poisson distribution. The data is probably already normalized!
...
p <- ggplot(df) + 
    ...
    theme_minimal() + 
    labs(x = 'Gene mean exp. (norm.)', y = 'Gene exp. CV2')
```

Fitting gene expression CV2 ~ mean seems to be more robust than gene expression variance ~ mean, here. 
