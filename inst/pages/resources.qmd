...
- ***The*** 150+ pages comprehensive book to learn everything about Bioconductor. This ebook has been published by [Kasper D. Hansen](https://www.ashansenlab.com/) and is freely available under the [CC BY-NC-SA 4.0 license](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en_US): [PDF](/resources/bioconductor.pdf)
- A digested [PowerPoint](/resources/R-essentials.pptx) summarizing two R/Bioconductor fundamental classes: `GRanges` and `*Experiment` classes
